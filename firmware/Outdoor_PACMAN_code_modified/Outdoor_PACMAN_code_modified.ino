...
int attack; //Variable used for the panic attack flag
int firstloop = 1; //Is it the first loop? Used to store the headers in the file.
...
long int average;
int Nsamples = 100; //Number of readings to take from the dust sensor
int count = 0;
